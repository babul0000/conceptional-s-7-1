import QuickCheckIn from '@/components/click/QuickCheckIn';
...
const RouterPage = async ({params}) => {
    ...
    const stat = (status) => {
        ...
        if (status) return "bg-orange-400 text-white";
            ...
            <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="space-y-4">
                    <div className="bg-white p-6 rounded-xl text-center shadow">
                        ...
                        <div className={`w-fit mx-auto px-3 py-1 text-sm mt-2 font-semibold rounded-full ${stat(status)}`}>
                            {status}
                        </div>
